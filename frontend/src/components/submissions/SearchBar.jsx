...
const SearchBar = ({ initialValue = '', onSearch, placeholder = 'Search submissions by task name or intern name...' }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full relative flex items-center font-sans">
      ...
      <button
        type="submit"
        className="ml-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-5 rounded-xl text-xs transition-colors cursor-pointer shadow-sm hover:shadow-md shrink-0"
      >
        Search
      </button>
    </form>
