...
const DeleteInternModal = ({ isOpen, onClose, onConfirm, internName }) => {
      ...
      >
        ...
        <div className="p-6">
          <p className="text-sm text-slate-600 font-medium leading-relaxed">
            Are you sure you want to permanently delete the intern profile for{' '}
            <strong className="text-slate-950 font-bold">{internName}</strong>?
          </p>
          <p className="text-xs text-rose-500/90 mt-2 font-semibold bg-rose-50/70 border border-rose-100 p-2.5 rounded-lg">
            Warning: This action will delete their profile, user account, and cannot be undone.
          </p>
        </div>
...
export default DeleteInternModal;
